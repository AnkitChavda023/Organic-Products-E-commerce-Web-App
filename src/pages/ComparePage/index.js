        ...
        <div className="breadcrumWrapper mb-4">
          <div className="container-fluid">
            <h6 className="text-black">
              ...
              &nbsp; <ChevronRightIcon /> <CompareArrowsOutlinedIcon /> Compare{" "}
            </h6>
          </div>
        </div>
          ...
          <div className="container-fluid">
            <div className="row">
              <div className="carthead d-flex align-items-center  w-100 mb-2">
                <div className="left">
                  <h3 className="hd mb-3"> Your Comparision</h3>
                  <p>
                    {" "}
                    There are <span className="text-g ">
                      {data.length}
                    </span>{" "}
